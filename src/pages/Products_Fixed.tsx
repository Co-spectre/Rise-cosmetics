...
const Products = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      {/* Hero Section */}
      <section className="relative py-20 bg-gradient-to-r from-olive-900 via-olive-800 to-olive-900">
        {/* Background Pattern */}
              ...
              {filteredProducts.map((product, index) => (
                ...
                >
                    ...
                    <div className="relative group-hover:scale-110 transition-transform duration-500">
                      {product.images && product.images[0] ? (
                        <img 
                          ...
                          alt={product.name}
                          className="w-32 h-40 object-cover rounded-sm shadow-2xl"
                        />
                      ) : (
                        // Fallback bottle visualization
                        <div>
                  ...
                  <div className="p-8 space-y-6">
                    <div>
                      <p className="text-olive-600 text-xs tracking-[0.2em] uppercase mb-3 font-medium">{product.category}</p>
                      ...
                      <p className="text-olive-700/80 text-base tracking-wide font-light">{product.shortDescription || product.name}</p>
                    </div>

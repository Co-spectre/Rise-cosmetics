...
export class ProductService {
  ...
  async deleteProduct(id: string): Promise<void> {
    try {
      ...
      console.log(`Product ${id} deleted (simulated)`);
    }
  }
  ...
  // Mock data for development - Premium RISE Cosmetics Collection
    ...
    return [
      {
        ...
        images: [getAssetPath('/images/products/IMG-20250808-WA0006.jpg')],
        inStock: true,
        stockQuantity: 45,
        featured: true,
        rating: 4.9,
      ...
      },
      {
        ...
        images: [getAssetPath('/images/products/IMG-20250808-WA0007.jpg')],
        inStock: true,
        stockQuantity: 32,
        featured: true,
        rating: 4.8,
      ...
      },
      {
        ...
        images: [getAssetPath('/images/products/IMG-20250808-WA0008.jpg')],
        inStock: true,
        stockQuantity: 58,
        featured: false,
        rating: 4.7,
      ...
      },
      {
        ...
        images: [getAssetPath('/images/products/IMG-20250808-WA0009.jpg')],
        inStock: true,
        stockQuantity: 73,
        featured: true,
        rating: 4.9,
      ...
      },
      {
        ...
        images: [getAssetPath('/images/products/IMG-20250808-WA0010.jpg')],
        inStock: true,
        stockQuantity: 18,
        featured: true,
        rating: 4.8,
      ...
      },
      {
        ...
        images: [getAssetPath('/images/products/IMG-20250808-WA0011.jpg')],
        inStock: true,
        stockQuantity: 95,
        featured: false,
        rating: 4.6,
      ...
      },
      {
        ...
        images: [getAssetPath('/images/products/IMG-20250808-WA0012.jpg')],
        inStock: true,
        stockQuantity: 127,
        featured: false,
        rating: 4.5,
      ...
      },
      {
        ...
        images: [getAssetPath('/images/products/IMG-20250808-WA0013.jpg')],
        inStock: true,
        stockQuantity: 87,
        featured: true,
        rating: 4.7,
      ...
      },
      {
        ...
        images: [getAssetPath('/images/products/IMG-20250808-WA0014.jpg')],
        inStock: true,
        stockQuantity: 64,
        featured: false,
        rating: 4.8,
      ...
      },
      {
        ...
        images: [getAssetPath('/images/products/IMG-20250808-WA0015.jpg')],
        inStock: true,
        stockQuantity: 43,
        featured: true,
        rating: 4.9,
